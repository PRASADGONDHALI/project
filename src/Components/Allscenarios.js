...
const AllScenarios = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://projectvehicle.onrender.com/api/items")
  ...
  const handleDelete = (itemId) => {
    ...
    fetch(`https://projectvehicle.onrender.com/api/items/${itemId}`, {
      method: "DELETE",
    })
      .then((response) => response.json())
  ...
  const handleSave = () => {
    ...
    fetch(`https://projectvehicle.onrender.com/api/items/${editingItemId}`, {
      method: "PUT",
      headers: {
