...
function Home() {
  ...
  const fetchItems = async () => {
    try {
      const response = await fetch("https://projectvehicle.onrender.com/api/items");
  ...
  const handleSaveClick = async (index) => {
    try {
      ...
      const response = await fetch(
        `https://projectvehicle.onrender.com/api/items/${selectedItemData._id}/vehicles/${updatedVehicle._id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDeleteClick = async (index) => {
    try {
      ...
      const response = await fetch(
        `https://projectvehicle.onrender.com/api/items/${selectedItemData._id}/vehicles/${vehicleToDelete._id}`,
        {
          method: "DELETE",
        }
      );
